...
%
% Judul laporan.
\def\judul{Penalaran Logika Berbasis Framework Translation-Decomposition-Search-Resolve pada Open-Weight Large Language Model dengan Dataset Berbahasa Indonesia}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Logical Reasoning Framework Translation-Decomposition-Search-Resolve on Open-Weight Large Language Model with Indonesian Language Dataset}
