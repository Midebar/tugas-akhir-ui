...
%
% Judul laporan.
\def\judul{Kemampuan LLM dalam Logical Inference pada Dataset Berbahasa Indonesia}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{The Capability of LLM in Logical Inference on Indonesian Language Dataset}
...
\Var{\babTiga}{Eksperimen dan Hasil Penelitian}
