...
%
% Judul laporan.
\def\judul{Penalaran Logika Berbasis \textit{Framework Translation-Decomposition-Search-Resolve} pada \textit{Open-Weight Small Language Model} dengan Dataset Berbahasa Indonesia}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Logical Reasoning with Translation-Decomposition-Search-Resolve Framework on Open-Weight Small Language Model for Indonesian Language Dataset}
...
\def\penulisSatu{Mikhael Deo Barli} % nama lengkap penulis pertama
...
\def\npmSatu{1906350572} % NPM penulis pertama
...
\def\pengujiDua{Arlisa Yuliawati, S.Kom., M.Kom}
...
% penguji/sekretariat
\def\tanggalSiapSidang{4 Januari 2026}
%
% Tuliskan tanggal keputusan sidang dikeluarkan dan penulis dinyatakan
% lulus/tidak lulus
\def\tanggalLulus{4 Januari 2026}
...
\Var{\babTiga}{Framework \textit{Translation-Decomposition-Search-Resolve}}
\Var{\babEmpat}{Eksperimen, Hasil, dan Analisis}
\Var{\babLima}{Studi Ablasi}
