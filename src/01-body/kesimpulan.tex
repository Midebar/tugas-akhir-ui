...
\begin{enumerate} 
	\item \textbf{Mekanisme Penalaran Logis pada Bahasa Indonesia:}
	      ...
	      \begin{enumerate}
		      ...
		      \item \textbf{\textit{Logical Resolver}}, yang melakukan deduksi deterministik menggunakan prinsip resolusi untuk menghasilkan jawaban yang valid secara simbolik.
	      \end{enumerate}
