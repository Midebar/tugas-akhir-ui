...
Bab ini menguraikan rancangan operasional yang digunakan untuk menjawab rumusan masalah penelitian. Metodologi ini disusun untuk menguji secara empiris apakah pendekatan \textit{Neuro-Symbolic}, khususnya kerangka kerja Aristotle yang telah dibahas pada Bab~\ref{bab:2}, dapat mengatasi kelemahan penalaran probabilistik pada \textit{open-weight} \textit{Large Language Models} (LLM) dalam konteks Bahasa Indonesia.
