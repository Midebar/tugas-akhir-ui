...
\section{Illustrasi}
Untuk memperjelas proses inferensi menggunakan kerangka kerja Aristotle, berikut adalah ilustrasi langkah demi langkah sebagai contoh dari dataset ProntoQA.
...
Sebelum dataset ProntoQA dijalankan dalam \textit{framework Aristotle}, dilakukan translasi ke bahasa Indonensia karena dataset tersebut masih dalam bahasa Inggris.
...
Output FOL dari tahap sebelumnya kemudian diproses untuk konversi ke CNF:
\begin{itemize}
