...
\begin{figure}
    ...
    \captionof{figure}{Kerangka kerja Aristotle untuk inferensi logika menggunakan LLM dan metode \textit{neuro-symbolic} (\cite{Aristotle25})}
...
Ini adalah satu-satunya tahap yang menggunakan "kecerdasan" probabilistik LLM. Tujuannya adalah memetakan kalimat Bahasa Indonesia yang implisit menjadi struktur logika formal.
...
Ini adalah mesin inferensi deterministik yang menggantikan peran penalaran LLM.
