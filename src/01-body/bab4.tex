...
\begin{itemize}
	\item Jika Model gagal dalam tahap \textit{translation}, seperti "Setiap Wumpus adalah Jompus" menjadi $\bracket{\forall x} {(\bracket{Wumpus}{(x)})} \rightarrow \bracket{Jompus}{(x)}$ dengan sintaks yang tepat 100\%, maka modul \textit{search} tidak akan memiliki input yang valid, dan akurasi otomatis menjadi 0.
