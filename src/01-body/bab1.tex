...
Penelitian ini dilakukan menggunakan \textit{framework} yang sudah diusulkan pada penelitian sebelumnya, tetapi penelitian ini menggunakan dataset berbahasa Indonesia dengan open-weight LLM berparameter rendah dengan kuantisasi. 
% \todo{
